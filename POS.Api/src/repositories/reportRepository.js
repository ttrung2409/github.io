...
export default class ReportRepository {
  ...
  getIncomeByCustomer(params) {
    return context.query('select * from "getIncomeByCustomer"(:customerId, :fromDate, :toDate, :skip, :take, :orderBy, :isDesc)', {
      replacements: {
        customerId: params.customerId || null,
        fromDate: params.fromDate || null,
        toDate: params.toDate || null,
  ...
  getIncomeSummaryByCustomer(params) {
    return context.query('select * from "getIncomeSummaryByCustomer"(:customerId, :fromDate, :toDate)', {
      replacements: {
        customerId: params.customerId || null,
        fromDate: params.fromDate || null,
        toDate: params.toDate || null
